...
if(document.getElementsByClassName("topnav_text_links").length == 4){
  document.getElementsByClassName("topnav_text_links")[2].className = "currentTextLink";
}
